 ...
 * <p>Description: Helper class containing some utility methods useful when
 * retrieving data for a grid.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 *
 * <p> This file is part of OpenSwing Framework. This library is free software;
 * you can redistribute it and/or modify it under the terms of the (LGPL) Lesser
 ...
 *
 * The author may be contacted at: maurocarniel@tin.it</p>
 *
...
public class JPAUtils {
     ...
     */
    public static String getValueObjectAlias(
            Class valueObjectType,
            String baseSQL) throws Exception {
    ...
    /**
     * Apply filtering and sorting conditions to the specified baseSQL and
     * return a new baseSQL that contains those conditions too.
     *
     ...
     * @param valueObjectAlias alias used to identify the value object to
     * retrieve
     */
    public static String applyFiltersAndSorter(
            ...
            String valueObjectAlias) throws Exception {
    ...
    /**
     * Apply filtering and sorting conditions to the specified baseSQL and
     * return a new baseSQL that contains those conditions too. SQL is expressed
     * using more argument, each one without the related keyword (select, from,
     * ...).
     *
     * Example: following query
     *
     * select customer_code,corporate_name from companies order by customer_code
     * asc
     *
     * become an invokation of getSql:
     *
     * getSql(userSessionPars,"customer_code,corporate_name","companies","","customer_code
     * asc","","",...);
     *
     * @param filteredColumns filtering conditions
     * @param currentSortedColumns sorting conditions (attribute names)
    ...
    /**
     * Read the whole result set, by applying filtering and sorting conditions +
     * query parameters.
     *
     * @param filteredColumns filtering conditions
     * @param currentSortedColumns sorting conditions (attribute names)
    ...
    public static Response getAllFromQuery(
            ...
            Object[] paramValues,
            EntityManager em,
            org.apache.log4j.Logger logger) throws Exception {
        return getAllFromQuery(
                filteredColumns,
                currentSortedColumns,
                currentSortedVersusColumns,
    ...
    /**
     * Read the whole result set, by applying filtering and sorting conditions +
     * query parameters. SQL is expressed using more argument, each one without
     * the related keyword (select, from, ...).
     *
     * Example: following query
     *
     * select customer_code,corporate_name from companies order by customer_code
    ...
    /**
     * Read a block of records from the result set, by applying filtering and
     * sorting conditions + query parameters.
     *
    ...
    /**
     * Read a block of records from the result set, by applying filtering and
     * sorting conditions + query parameters. SQL is expressed using more
     * argument, each one without the related keyword (select, from, ...).
     *
     * Example: following query
     *
     * select customer_code,corporate_name from companies order by customer_code
    ...
    /**
     * Read a block of records from the result set, starting from a Query
     * object.
     *
     * @param action fetching versus: PREVIOUS_BLOCK_ACTION, NEXT_BLOCK_ACTION
     * or LAST_BLOCK_ACTION
