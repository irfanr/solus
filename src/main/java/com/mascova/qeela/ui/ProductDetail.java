 ...
 * @author irfan
 */
public class ProductDetail extends InternalFrame {

    public static final int WEIGHT = 470;
    public static final int HEIGHT = 250;
    private ProductDetailController pdc = null;
    private Action closeAction = null;

    /**
     * Creates new form ProductDetail
     */
    public ProductDetail(ProductDetailController pdc) {
    ...
    private String getValueObjectClassName() {
        return "com.mascova.qeela.entity.Product";
    }
