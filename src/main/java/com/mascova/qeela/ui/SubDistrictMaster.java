 ...
 * @author irfan
 */
public class SubDistrictMaster extends InternalFrame {

    private SubDistrictMasterController sdmc = null;
    private DistrictLookupController dlc = null;

    /**
     * Creates new form SubDistrictMaster
     */
    public SubDistrictMaster(SubDistrictMasterController sdmc, DistrictLookupController clc) {
        this.sdmc = sdmc;
        this.dlc = clc;
        initComponents();
        gridControl.setController(sdmc);
        districtCodLookupColumn.setLookupController(clc);
    ...
    private void initComponents() {
        ...
        districtCodLookupColumn = new org.openswing.swing.table.columns.client.CodLookupColumn();
        ...
        districtCodLookupColumn.setColumnName("district.name");
        districtCodLookupColumn.setEditableOnEdit(true);
        districtCodLookupColumn.setEditableOnInsert(true);
        gridControl.getColumnContainer().add(districtCodLookupColumn);
    ...
    private org.openswing.swing.table.columns.client.CodLookupColumn districtCodLookupColumn;
