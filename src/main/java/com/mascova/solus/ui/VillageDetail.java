...
import com.mascova.solus.controller.SubDistrictLookupController;
 ...
 * @author irfan
 */
public class VillageDetail extends InternalFrame {

    /**
     * Creates new form VillageDetail
     */
    public static final int WEIGHT = 470;
    public static final int HEIGHT = 250;
    private VillageDetailController pdc = null;
    private SubDistrictLookupController clc = null;

    public VillageDetail(VillageDetailController pdc, SubDistrictLookupController clc) {
        this.pdc = pdc;
        this.clc = clc;
        initComponents();
        subDistrictCodLookupControl.setLookupController(clc);
//        this.setSize(WEIGHT, HEIGHT);  
    ...
    private String getValueObjectClassName() {
        return "com.mascova.solus.entity.Village";
    }
    ...
    private void initComponents() {
        ...
        subDistrictCodLookupControl = new org.openswing.swing.client.CodLookupControl();
        ...
        subDistrictCodLookupControl.setAttributeName("subDistrict.name");
        subDistrictCodLookupControl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                subDistrictCodLookupControlActionPerformed(evt);
            }
        });

        labelControl1.setLabel("Name");

        labelControl2.setLabel("Sub District");
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(subDistrictCodLookupControl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void subDistrictCodLookupControlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subDistrictCodLookupControlActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_subDistrictCodLookupControlActionPerformed
    ...
    private org.openswing.swing.client.CodLookupControl subDistrictCodLookupControl;
